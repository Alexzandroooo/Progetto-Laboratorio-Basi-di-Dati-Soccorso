...
-- --------------------------------------------------------------------
-- Usiamo LAST_INSERT_ID() come mostrato a pagina 57 della teoria del docente
-- per collegare automaticamente la tabella padre e la tabella di dettaglio.
...
-- --------------------------------------------------------------------
-- Chiamata alla procedura creata per gestire i vincoli complessi,
-- operazione raccomandata nella premessa della specifica del progetto.
CALL avvia_missione(3, 'Via Roma 10, Milano');

INSERT INTO assegnamento (codice_missione, ID_utente, ruolo) 
VALUES (3, 2, 'caposquadra');
...
-- WHERE u.email = 'sara@operatore.it'
...
SELECT ip, COUNT(*) AS numero_richieste
FROM richiesta
